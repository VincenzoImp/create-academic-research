  ...
  skill_bundles: {
    ...
    optional_mechanical_specialists: {
      ...
      commands: [
        ...
        "npm exec --yes --package skills -- skills add lllllllama/ai-paper-reproduction-skill {agent_flag} --skill ai-research-reproduction repo-intake-and-plan env-and-assets-bootstrap minimal-run-and-audit paper-context-resolver analyze-project safe-debug run-train explore-run explore-code --copy -y"
      ]
    }
  },
  presets: {
